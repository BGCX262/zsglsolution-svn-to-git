...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example"   width=570 style="font-size:12px;">
    <thead>
    <tr>
    <th width="200">用户名</th>
    ...
    <%foreach (var user in Model.Users)
      ...
      <td class=" sorting_1" align=center><%=Ajax.ActionLink("启用", "EnabledZyh", new { userId = user.user_id }, new AjaxOptions { })%></td>
      </tr>
    <%} %>
    </tbody>
</table>
